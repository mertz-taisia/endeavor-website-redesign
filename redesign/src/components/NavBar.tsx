...
const NavBar: React.FC<NavBarProps> = () => {
  ...
  const [companyTimeout, setCompanyTimeout] = useState<number | null>(null);
    ...
    <nav className="bg-transparent w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 absolute top-0 left-0 z-10">
      <div className="flex justify-between items-center max-w-[1400px] mx-auto">
        ...
        <div className="hidden lg:flex items-center gap-10">
          ...
          {/* AI Platform */}
          <a href="" className="text-[#c7c7c7] text-sm hover:text-white transition-colors duration-200 ease-in-out cursor-[url('/cursor.svg')_12_12,_auto] whitespace-nowrap">AI Platform</a>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            <nav className="bg-transparent w-full h-full flex flex-col">
              {/* Header with logo and close button */}
              <div className="flex justify-between items-center p-5 border-b border-[#2a2a33]">
                ...
                <button 
                  ...
                  className="text-white bg-transparent p-2 hover:bg-transparent focus:bg-transparent focus:outline-none focus:ring-0 cursor-[url('/cursor.svg')_12_12,_auto]"
              ...
              <div className="flex flex-col w-full flex-grow overflow-hidden px-5">
              {/* Solutions Dropdown */}
                  ...
                  {mobileSolutionsOpen && (
                    ...
                    >
                      <div className="flex flex-col space-y-3 mt-3 w-full">
                        <a href="" className="text-[#a0a0a0] hover:text-white text-[15px] transition-colors duration-200 block w-full pl-8 text-left cursor-[url('/cursor.svg')_12_12,_auto]">Solution 1</a>
                        <a href="" className="text-[#a0a0a0] hover:text-white text-[15px] transition-colors duration-200 block w-full pl-8 text-left cursor-[url('/cursor.svg')_12_12,_auto]">Solution 2</a>
                        <a href="" className="text-[#a0a0a0] hover:text-white text-[15px] transition-colors duration-200 block w-full pl-8 text-left cursor-[url('/cursor.svg')_12_12,_auto]">Solution 3</a>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
              ...
              {/* AI Platform */}
              <div className="w-full border-b border-[#2a2a33] py-5 px-6">
                <a href="" className="bg-transparent flex w-full items-center text-[#e0e0e0] hover:text-white text-left text-[16px] font-medium transition-colors duration-200 whitespace-nowrap">
                  <span>AI Platform</span>
                </a>
              </div>
              {/* Customers */}
              <div className="w-full border-b border-[#2a2a33] py-5 px-6">
                <a href="" className="bg-transparent flex w-full items-center text-[#e0e0e0] hover:text-white text-left text-[16px] font-medium transition-colors duration-200">
                  <span>Customers</span>
                </a>
              </div>
              {/* Company Dropdown */}
              <div className="w-full border-b border-[#2a2a33] py-5">
                ...
                >
                  <span>Company</span>
                  <svg 
                    className={`w-5 h-5 transition-transform duration-300 ${mobileCompanyOpen ? 'rotate-180' : ''}`} 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24" 
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <AnimatePresence>
                  {mobileCompanyOpen && (
                    ...
                    >
                      <div className="flex flex-col space-y-3 mt-3 w-full">
                        <a href="" className="text-[#a0a0a0] hover:text-white text-[15px] transition-colors duration-200 block w-full pl-8 text-left cursor-[url('/cursor.svg')_12_12,_auto]">About Us</a>
                        <a href="" className="text-[#a0a0a0] hover:text-white text-[15px] transition-colors duration-200 block w-full pl-8 text-left cursor-[url('/cursor.svg')_12_12,_auto]">Careers</a>
                        <a href="" className="text-[#a0a0a0] hover:text-white text-[15px] transition-colors duration-200 block w-full pl-8 text-left cursor-[url('/cursor.svg')_12_12,_auto]">Team</a>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
              {/* Contact Us Button mobile - positioned at bottom */}
              <div className="mt-auto pt-4 pb-8 flex w-full border-t border-[#2a2a33] max-w-full px-5">
                <a 
                  href="" 
                  className="bg-transparent flex w-full items-center text-[#e0e0e0] hover:text-white text-left text-[16px] font-medium transition-colors duration-200 py-3 cursor-[url('/cursor.svg')_12_12,_auto] overflow-hidden"
                >
