...
const NavBar: React.FC<NavBarProps> = ({ logoSize = 'w-44' }) => {
  ...
  return (
    <nav className="bg-transparent w-full px-8 py-6 absolute top-0 left-0 z-10">
